...
public:
    ViewerWidget(QWidget* parent = 0, Qt::WindowFlags f = 0, osgViewer::ViewerBase::ThreadingModel threadingModel=osgViewer::CompositeViewer::SingleThreaded) : QWidget(parent, f)
    {
        ...
        QWidget* widget1 = addViewWidget( createGraphicsWindow(0,0,800,600), osgDB::readRefNodeFile("cow.osgt") );
...
int main( int argc, char** argv )
{
    ...
    viewWidget->setGeometry( 0, 0, 800, 600 );
    viewWidget->show();
    return app.exec();
}