...
{
  std::string config_color = "cad/rs.xml", config_depth = "cad/rs_depth.xml";
  std::string model_color = "cad/damo.cao", model_depth = "cad/damo.cao";
  std::string init_file = "cad/damo.init";
  bool use_ogre = false;
